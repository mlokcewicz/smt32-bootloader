...
/// @brief Erases the Flash pages covering the requested address range.
/// @param start_addr Start address of the Flash range to erase.
/// @param size Size of the Flash range in bytes.
/// @return true if all required pages are erased successfully, otherwise false.
bool flash_erase(uint32_t start_addr, uint32_t size);

/// @brief Programs an array of 64-bit doublewords into Flash memory.
/// @param start_addr Start address of the Flash range to program. Must be aligned to 8 bytes.
/// @param data Array containing the doublewords to program.
/// @param dwords Number of doublewords in the data array.
/// @return true if all doublewords are programmed successfully, otherwise false.
